...
public class AccionInsertarGrupoSec extends ExecuteTransaccional {

    private Grupo oGrupo;

    public AccionInsertarGrupoSec(Grupo oGrupo) {
        this.oGrupo = oGrupo;
    }
    ...
    public Map execute(Connection conn) throws Exception {
        ...
        Long id = new DAOGrupo().insertarSec(conn, oGrupoBD);
