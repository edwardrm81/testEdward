...
public class AccionInsertarUsuarioAInc extends ExecuteTransaccional {

    private Usuario oUsuario;

    public AccionInsertarUsuarioAInc(Usuario oUsuario) {
    ...
    public Map execute(Connection conn) throws Exception {
        ...
        new DAOUsuario().insertarAInc(conn, oUsuarioBD);
        Long id = new DAOUsuario().getUltimoIdInsertado(conn);
