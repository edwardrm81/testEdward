...
public class AccionInsertarUsuario extends ExecuteTransaccional {

    private Usuario oUsuario;

    public AccionInsertarUsuario(Usuario oUsuario) {
    ...
    public Map execute(Connection conn) throws Exception {
        ...
        new DAOUsuario().insertar(conn, oUsuarioBD);

        Map oMap = new HashMap();
        oMap.put("usuario",oUsuarioBD);
        return oMap;
    }
